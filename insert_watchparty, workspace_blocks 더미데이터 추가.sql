...
-- 16-1. wa_sync 테이블 데이터 삽입 (sync_idx: 1 ~ 100, 각 watchParty에 5개씩)
INSERT ALL
  /* format: sync_idx, timeline (s), play state, watchParty_idx */
  ...
  /* … 반복하여 watchParty_idx = 4 … 20 */
SELECT * FROM dual;

/* 실제로는 위 패턴을 sync_idx = 1..100, watchParty_idx = 1..20 각각 5개씩 이어서 작성합니다 */

-- 16-2. wa_comment 테이블 데이터 삽입 (wac_idx: 1 ~ 40, 각 watchParty에 2개씩)
INSERT ALL
  /* format: wac_idx, nickname, commnet, timeline, watchParty_idx */
  INTO wa_comment (wac_idx, nickname, commnet, timeline, watchParty_idx) VALUES ( 1, '날쎈돌이16',    '시작부터 재미있네요!',      5.000,  1)
  INTO wa_comment (wac_idx, nickname, commnet, timeline, watchParty_idx) VALUES ( 2, '영화광팬',      '이 부분이 특히 인상적이에요!', 55.000, 1)
  INTO wa_comment (wac_idx, nickname, commnet, timeline, watchParty_idx) VALUES ( 3, '음악없인못살아','시작부터 재미있네요!',      5.000,  2)
  INTO wa_comment (wac_idx, nickname, commnet, timeline, watchParty_idx) VALUES ( 4, '웹툰장인17',    '이 부분이 특히 인상적이에요!', 55.000, 2)
  INTO wa_comment (wac_idx, nickname, commnet, timeline, watchParty_idx) VALUES ( 5, '드라마덕후',    '시작부터 재미있네요!',      5.000,  3)
  INTO wa_comment (wac_idx, nickname, commnet, timeline, watchParty_idx) VALUES ( 6, 'SF매니아',      '이 부분이 특히 인상적이에요!', 55.000, 3)
  /* … 반복하여 watchParty_idx = 4 … 20, wac_idx = 7..40 각각 2개씩 이어서 작성합니다 */
SELECT * FROM dual;
