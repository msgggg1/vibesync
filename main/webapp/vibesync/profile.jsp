      ...
      <nav class="notion-sidebar-container" id="sidebar">
        <div class="notion-sidebar">
          <div class="menu_content">
            ...
            <a class="nickname icon_wrap" href="${pageContext.request.contextPath}/profile.do">
              <span>${userProfile.nickname}</span>
            </a>

            <div class="search icon_wrap">
              <img src="${pageContext.request.contextPath}/sources/icons/search.svg" alt="search icon" class="sidebar_icon">
              <input type="text" class="search-input" placeholder="Search…">
            </div>

            <a href="${pageContext.request.contextPath}/main.do" class="home icon_wrap">
              <img src="${pageContext.request.contextPath}/sources/icons/home.svg" alt="" class="sidebar_icon">
              <span>HOME</span>
            </a>

            <a href="${pageContext.request.contextPath}/workspace.html" class="workspace icon_wrap">
              <img src="${pageContext.request.contextPath}/sources/icons/work.svg" alt="" class="sidebar_icon">
              <span>WORKSPACE</span>
            </a>
            ...
            <div id="follow">
              <div class="follow_list">
                ...
                <ul class="follow_items">
                  <li><a href="${pageContext.request.contextPath}/postView.do">PostView</a></li>
                  <li><a href="${pageContext.request.contextPath}/list.do">List</a></li>
                </ul>
              </div>
            </div>
